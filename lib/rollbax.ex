defmodule Rollbax do
  ...
  def report_message(level, message, custom \\ %{}, occurrence_data \\ %{})
    ...
    Rollbax.Client.emit(level, System.system_time(@second_time_unit), body, custom, occurrence_data)
  end
  ...
  def report_exception(%Rollbax.Exception{} = exception) do
    ...
    Rollbax.Client.emit(:error, System.system_time(@second_time_unit), body, custom, occurrence_data)
  end
end
